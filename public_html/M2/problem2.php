...
function sumValues($arr, $arrayNumber)
{
    ...
    // Step 2: Iterate through $arr using foreach loop to sum values into $total
    // Step 3: Use number_format() to convert $total into a string with 2 decimal places for $modifiedTotal
